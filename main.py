    """
    Symlink Manager Em2dftk8
    ========================
    Lightweight terminal utility built to validate your filesystem and configurations.
    ...
    APP_NAME    = "Symlink Manager Em2dftk8"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight terminal utility built to validate your filesystem and configurations.")
